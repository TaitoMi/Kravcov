...
for (let i = 0; i < sexChoice.length; i++) {
	sexChoice[i].onclick = function() {
		...
		if (sexChoice[0].classList.contains('sex__choice_active')) {
			sexChoice[0].classList.remove('sex__choice_active');
			sexChoice[i].classList.add('sex__choice_active');
		}
		if (sexChoice[1].classList.contains('sex__choice_active')) {
			sexChoice[1].classList.remove('sex__choice_active');
			sexChoice[i].classList.add('sex__choice_active');
		}
	}
}
